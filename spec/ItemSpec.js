...
describe("Generar html per a preguntes individuals", function() {
      ...
      it("Generar una pregunta amb la resposta per radiobutton", function() {
        ...
        item.generarPregunta();
        stringExpected = "<form name='f666' tipus='3'><p id=666 obligatoria='false' >De quin color era el cavall blanc de Santiago?<br/><input type='radio' name='pregunta666' value=0>Roig</input><input type='radio' name='pregunta666' value=1>Negre</input><input type='radio' name='pregunta666' value=2>Blanc</input><input type='radio' name='pregunta666' value=3>Verd</input></p></form>";
        n= compara(stringExpected,item.html);
        expect(n).toEqual(-1);
      });
      ...
      it("Generar una pregunta amb drag and drop", function() {
          ...
          var n;
          item = new ItemDragAndDrop("Enunciat a preguntar |roig|blanc|verd|negre", Repostes, 666, false);
          item.generarPregunta();
        ...
        it("Generar una pregunta amb la resposta per radiobutton vertical", function() {
          var Repostes = ["Roig", "Negre", "Blanc", "Verd"];
          var n;
          item = new ItemRadioButtonVertical("De quin color era el cavall blanc de Santiago?", Repostes, 666, false);
          item.generarPregunta();
          stringExpected = "<form name='f666' tipus='6'><p id=666 obligatoria='false' >De quin color era el cavall blanc de Santiago?<br/><input type='radio' name='pregunta666' value=0>Roig</input><br/><input type='radio' name='pregunta666' value=1>Negre</input><br/><input type='radio' name='pregunta666' value=2>Blanc</input><br/><input type='radio' name='pregunta666' value=3>Verd</input><br/></p></form>";
          n=compara(item.html,stringExpected);
          expect(n).toEqual(-1);
        });
        it("Generar una pregunta amb múltiples respostes curtes", function() {
          var Repostes = ["Roig", "Negre", "Blanc", "Verd"];
          var n;
          item = new ItemMultiShortAnswer("De quin color era el cavall blanc de Santiago?", Repostes, 666, false,1);
          item.generarPregunta();
          stringExpected = "<form name='f666' tipus='7'><p id=666 obligatoria='false' >De quin color era el cavall blanc de Santiago?<br/><table><tr><td>Roig</td><td><input type='text' value='' name='resposta666_0' maxlength=1 size=3></input></td></tr><tr><td>Negre</td><td><input type='text' value='' name='resposta666_1' maxlength=1 size=3></input></td></tr><tr><td>Blanc</td><td><input type='text' value='' name='resposta666_2' maxlength=1 size=3></input></td></tr><tr><td>Verd</td><td><input type='text' value='' name='resposta666_3' maxlength=1 size=3></input></td></tr></table></p></form>";
          n=compara(item.html,stringExpected);
          expect(n).toEqual(-1);
        });
